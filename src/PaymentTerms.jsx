      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-sm leading-6">
          ...
          <section>
            ...
            <p className="mt-2">
              После подтверждения оплаты пользователю начисляется по 20 операций каждого типа: 
              генераций деревьев метрик, AI-разборов метрик, подсказок метрик, приоритизаций и генераций A/B-экспериментов. 
              Купленные операции не имеют срока действия. Неиспользованный остаток сохраняется, 
              а повторная покупка добавляет ещё по 20 операций каждого типа. Бесплатные попытки при покупке не обнуляются.
            </p>
          ...
          <section>
            ...
            <p>
              ...
              После подтверждения успешной оплаты приобретённые операции
              начисляются на баланс аккаунта пользователя.
            </p>
